function Footer() {
  return (
    <div className="container-fluid border-top p-2 " style={{background:"#FBFBFB"}}>
      <div className="row mb-5 mt-5 mx-5">
        <div className="col">
          <img
            ...
            srcset=""
          />
          <p className="" style={{fontSize:"15px",marginTop:"9px",padding:"4px",marginRight:"10px"}}>© 2010 - 2025, Zerodha Broking Ltd.
...
<a href="">Sectors</a><br />
      ...
      <div className="mt-5 mb-5 text-muted mx-5 " style={{fontSize:"11px"}}>
